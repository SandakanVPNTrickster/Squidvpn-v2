...
echo -e "${green}════════════════════════════════════════════════════════════${NC}"
echo -e "$Yellow (•1) $NC PANEL SSH & OPENVPN         $green (•7) $NC SYSTEM MENU "
echo -e "$green (•2) $NC PANEL WIREGUARDS            $Yellow (•8) $NC SERVER INFORMATION "
echo -e "$Yellow (•3) $NC PANEL VMESS & VLESS         $green (•9) $NC LOG CREATED CONFIG "
echo -e "$green (•4) $NC PANEL TROJAN                $Yellow (10) $NC CHECK USAGE "
